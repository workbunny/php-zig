...
pub extern fn phpglue_register_class_full(
    ...
    methods: ?*anyopaque,
    const_count: c_int,
    const_keys: [*c]const [*c]const u8,
    const_key_lens: [*c]usize,
    const_vals: [*c]const ?*anyopaque,
    const_val_lens: [*c]usize,
    const_types: [*c]u8,
    prop_count: c_int,
    prop_keys: [*c]const [*c]const u8,
    prop_key_lens: [*c]usize,
    prop_vals: [*c]const ?*anyopaque,
    prop_val_lens: [*c]usize,
    prop_accesses: [*c]u32,
    prop_types: [*c]u8,
) c_int;
